...
<html>
	...
	<body>
		<div class="wrap-container">
					...
					@endif
				<form class="layui-form" action="{{url('admin/category/save')}}" method="post" style="width: 90%;padding-top: 20px;">
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input type="text" value="{{old('username')}}" name="cname" required lay-verify="required" placeholder="请输入标签" autocomplete="off" class="layui-input">
						</div>
					</div>
					<div class="layui-form-item">
						<div class="layui-input-block">
